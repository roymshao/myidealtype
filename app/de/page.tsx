...
export const metadata: Metadata = {
  title: "Germany Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Germany men or women match your dating standards? Real Destatis Zensus 2022 data.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇩🇪 Germany · Destatis Zensus 2022, RKI health data, Destatis income 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Sind deine Ansprüche realistisch?
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="27M+" label="Germany men analyzed" />
        <Stat value="27M+" label="Germany women analyzed" />
        <Stat value="16" label="Germany cities" />
        <Stat value="Real data" label="Destatis Zensus 2022" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from Destatis Zensus 2022, RKI health data, Destatis income 2022.
