...
export const metadata: Metadata = {
  title: "Japan Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Japanese men or women match your dating standards? Real Japan NHNS + Statistics Bureau data.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇯🇵 Japan · Statistics Bureau + NHNS Data
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          あなたの理想の相手は{" "}
          <span className="italic text-slate-500">現実的</span>ですか？
        </h1>
        <p className="text-base text-slate-500 mb-2 italic">
          How realistic are your dating standards in Japan?
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center">
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center h-full py-10 px-6 gap-3">
              ...
              <span className="text-sm font-medium text-rose-200">女性 / Seeking men →</span>
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center h-full py-10 px-6 gap-3">
              ...
              <span className="text-sm font-medium text-blue-200">男性 / Seeking women →</span>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="36M+" label="Japanese men analyzed" />
        <Stat value="36M+" label="Japanese women analyzed" />
        <Stat value="16" label="Japanese cities" />
        <Stat value="Real data" label="Statistics Bureau · NHNS" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from Statistics Bureau Japan 2022, Japan National Health and Nutrition Survey (NHNS) 2019, and NHK Survey 2023.
