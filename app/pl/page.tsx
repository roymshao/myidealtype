...
export const metadata: Metadata = {
  title: "Poland Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Poland men or women match your dating standards? Real GUS NSP 2021 data.",
};

export default function PolandHomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇵🇱 Poland · GUS NSP 2021, NATPOL 2019, GUS wages 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Czy twoje wymagania są realistyczne? (Are your dating standards realistic?)
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="13M+" label="Poland men analyzed" />
        <Stat value="13M+" label="Poland women analyzed" />
        <Stat value="12" label="Poland cities" />
        <Stat value="Real data" label="GUS NSP 2021" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from GUS NSP 2021, NATPOL 2019, GUS wages 2022.
