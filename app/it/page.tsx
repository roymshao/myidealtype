...
export const metadata: Metadata = {
  title: "Italy Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Italy men or women match your dating standards? Real ISTAT Censimento 2021 data.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇮🇹 Italy · ISTAT Censimento 2021, OKkio alla Salute 2019, ISTAT redditi 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Sono realistici i tuoi standard?
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="19M+" label="Italy men analyzed" />
        <Stat value="19M+" label="Italy women analyzed" />
        <Stat value="12" label="Italy cities" />
        <Stat value="Real data" label="ISTAT Censimento 2021" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from ISTAT Censimento 2021, OKkio alla Salute 2019, ISTAT redditi 2022.
