...
export const metadata: Metadata = {
  title: "Sweden Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Sweden men or women match your dating standards? Real SCB 2022 data.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇸🇪 Sweden · SCB 2022, Folkhälsomyndigheten height data, SCB income 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Är dina krav realistiska? (Are your dating standards realistic?)
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="3.6M+" label="Sweden men analyzed" />
        <Stat value="3.6M+" label="Sweden women analyzed" />
        <Stat value="10" label="Sweden cities" />
        <Stat value="Real data" label="SCB 2022" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from SCB 2022, Folkhälsomyndigheten height data, SCB income 2022.
