...
export const metadata: Metadata = {
  title: "France Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of France men or women match your dating standards? Real INSEE RP 2019 data.",
};

export default function FranceHomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇫🇷 France · INSEE RP 2019, Esteban 2015, INSEE revenus 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Vos critères sont-ils réalistes ?
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="20M+" label="France men analyzed" />
        <Stat value="20M+" label="France women analyzed" />
        <Stat value="12" label="France cities" />
        <Stat value="Real data" label="INSEE RP 2019" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from INSEE RP 2019, Esteban 2015, INSEE revenus 2022.
