...
export const metadata: Metadata = {
  title: "Spain Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of Spain men or women match your dating standards? Real INE Censo 2021 data.",
};
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="15M+" label="Spain men analyzed" />
        <Stat value="15M+" label="Spain women analyzed" />
        <Stat value="12" label="Spain cities" />
        <Stat value="Real data" label="INE Censo 2021" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from INE Censo 2021, AECOSAN 2017, INE ECV 2022.
