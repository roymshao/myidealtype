...
export const metadata: Metadata = {
  title: "UK Mate Calculator — Are Your Dating Standards Realistic?",
  description: "What percentage of United Kingdom men or women match your dating standards? Real ONS Census 2021 data.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-16 bg-slate-50">
      <div className="text-center max-w-2xl w-full">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-400 mb-4">
          🇬🇧 UK · ONS Census 2021, UK Biobank, ONS ASHE 2022
        </p>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
          Are your dating standards realistic in the UK?
        </h1>
      ...
      <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
        <Stat value="22M+" label="UK men analyzed" />
        <Stat value="23M+" label="UK women analyzed" />
        <Stat value="16" label="UK cities" />
        <Stat value="Real data" label="ONS Census 2021" />
      </div>

      <footer className="mt-14 text-xs text-slate-400 text-center max-w-md leading-relaxed">
        Data from ONS Census 2021, UK Biobank, ONS ASHE 2022.
